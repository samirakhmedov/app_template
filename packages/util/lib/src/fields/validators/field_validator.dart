...
import 'package:util/src/fields/validators/fill_validator.dart';
import 'package:util/src/fields/validators/merged_validator.dart';
...
abstract class FieldValidator<T extends Object?> {
  ...
  FieldValidator<T> required(AppLocalizations localizations) =>
      MergedValidator([FillValidator<T>(localizations), this]);
}
