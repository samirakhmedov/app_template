...
import 'package:debug_presentation/src/widgets/rotation/rotation_layout.dart';
...
class _RotationComponentState
  ...
  void restoreState(RestorationBucket? oldBucket, bool initialRestore) {
    registerForRestoration(_angleState, _RestorationKeys.angle.key);
  }
  ...
  @override
  String get restorationId => _RestorationKeys.rotationTargetKey.key;
}
...
enum _RestorationKeys {
  ...
  const _RestorationKeys(this.key);
}
