...
mixin _$AppColorSchemeTailorMixin on ThemeExtension<AppColorScheme> {
  ...
  AppColorScheme lerp(
    ...
    return AppColorScheme(
      ...
      tetradicBackground: Color.lerp(
        tetradicBackground,
        other.tetradicBackground,
        t,
      )!,
      ...
      skeletonOnPrimary: Color.lerp(
        skeletonOnPrimary,
        other.skeletonOnPrimary,
        t,
      )!,
      skeletonSecondary: Color.lerp(
        skeletonSecondary,
        other.skeletonSecondary,
        t,
      )!,
      skeletonTertiary: Color.lerp(
        skeletonTertiary,
        other.skeletonTertiary,
        t,
      )!,
