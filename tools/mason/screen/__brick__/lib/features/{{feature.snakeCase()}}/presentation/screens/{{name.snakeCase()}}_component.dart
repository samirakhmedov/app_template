...
import 'package:app_template/features/{{feature.snakeCase()}}/presentation/screens/{{name.snakeCase()}}_layout.dart';
import 'package:flutter/material.dart';

/// {@template {{name.snakeCase()}}_component}
/// A component for the {{name.snakeCase()}} screen.
/// {@endtemplate}
...
/// A view model for the {{name.snakeCase()}} screen.
/// {@endtemplate}
